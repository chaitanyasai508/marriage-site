...
var files_list = [
    ...
    {
        path: "https://cdnjs.cloudflare.com/ajax/libs/gsap/1.19.1/TweenMax.min.js",
        message: "Loading file 4/" + total_file
    },
    {
        path: dir + "script.js",
...
var sbvplay = new Audio("./assets/music.mp3");
sbvplay.onended = function () {
    sbvplay.play();
};
...
function showInvitation() {
    ...
    setTimeout(function () {
        ...
        document.getElementById("speaker-off").style.fill = "#fff";
        document.getElementById("speaker-on").style.fill = "#fff";
        turnOnAudio();
    }, 1000);
